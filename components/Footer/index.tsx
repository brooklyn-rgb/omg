...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-[#180f34] bg-opacity-5 pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                A proudly 100% black, female-owned powerhouse dedicated to shaping the future of media talent, both in South Africa and beyond.
                </p>
                <p className="py-4">
                Location
                </p>
                <p>
                4 Beacon Street, New Doornfontein, Maboneng, Johannesburg, South Africa
                </p>
                <p>
                <br />Tel: 081 858 5645
                </p>                
        ...
        <div className="bg-dark/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              O.M.G Academy <a href="/" rel="nofollow noopener">| Designed By Mac</a>
            </p>
          </div>
        </div>
