...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`header top-0 left-0 z-40 flex w-full items-center bg-[#000000] bg-transparent ${
          sticky
            ? "!fixed !z-[000000] !bg-black !bg-opacity-80 shadow-sticky backdrop-blur-sm  dark:!bg-black dark:!bg-opacity-100"
            : "absolute"
        }`}
      >
          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                ...
                <Link
                  href="/registration"
                  className="ease-in-up hidden rounded-md bg-[#58400f] py-3 px-8 text-base font-bold text-white transition duration-300 hover:bg-opacity-90 hover:shadow-signUp md:block md:px-9 lg:px-6 xl:px-9"
                >
                 Registration
                </Link>
                <div>
